...
## :seven: (RESIO SAM OVO, A KOKO POGLEDAJ U `NOTES.md`) OPET MORAS DA PRAVIS SVAKI PUT CLEAN PRE NOVOG BUILD-AL VIDI ZASTO JE TO
...
## :one::two: TREBALO BI DA DEFINISES DA SE CODE BLOCKS MOGU SCROLL-OVATI I PRITISKOM STRELICA (URADJENO)
...
## :one::five: DODAO SI MALU SVINJU EMOJI; E PA DEFINISI NA PRIMER DA SE PRITISKOM NA NJU USTVARI UKLANJA PIG ANIMATION

U OVOM SLUCAJU MOZES DA KORISTIS I LOCAL STORAGE, DA SE INFO O PRIKAZIVANJU SVINJE UZIMA ODATLE

## :one::six: POGLEDAJ NAJBOLJE SEO PRAKSE SA SLEDECE STRANICE

<https://9elements.com/seo-cheat-sheet/?ref=tiny-helpers>

POGLEDAJ KAKO MOZES DA TO SVE IMPLEMENTIRAS U TVOJ WEBSITE

## :one::seven: KADA SCROLL-UJES PRVI PUT NA STRANICI SCROLL BUGG-UJE

ODNOSNO VRACA ME NA POCETAK DOK SCROLL-UJEM, SVE DOK SE ODJEDNOM NE POPRAVI SITUACIJA I MOGU DA SCROLL-UJEM

SUMNJE

- MOZDA SU CODE BLOCKS U PITANJU JER IH LAZYLY LOAD-UJEM (KORISTIM LIBRARY ZA TO)

PROVERI `packages/gatsby-theme-raedal/src/components/mdx-theme-ui-overrides/code.tsx`

- A MOZDA JE LAYING DOWN HEADER-A PROBLEMATICAN

ODNONO MOZDA INTERSECTION OBSERVER NESTO KOCI
...
# ::::::::: VIDI ZASTO TI NE FUNKCIONISE BUILD BEZ CLEANING-A CACHE-A

**NAIME ON OSTO ZNAM JESTE DA QUERY ZA `AuthorPage`-OVIMA VRACA PRAZAN NIZ**

**NE ZNAM ZASTO**

POCNI ODAVDE

<https://github.com/gatsbyjs/gatsby/issues/11747>

<https://github.com/gatsbyjs/gatsby/issues/12099>

IAKO JE MOZDA PROBLEM OCIGLEDNIJI

**ALI MOZDA JE OVAJ PROBLEM VEZAN SAMO ZA DEVELOPMENT I NECE SE DOGADJATI KADA BUDEM RADIO PRODUCTION**

JER VIDIM DA OVO LJUDI CESTO RADE, KONKRETNO VIDI MIZ SLEDECEG BLOG POST-A

<https://www.frontendstumbles.com/an-easy-fix-for-gatsby-caching-issues/>

A ZBOG OVOG PROBLEMA NETLIFY STARTER ISTO IMA BRISANJE CACHE-A, KO GLAVNU STVAR

# :::::::::::::::::::: VIDI DA LI TI TREBAJU OPEN GRAPH META TAGOVI

NJIH SAM UPRAVO VIDEO U HEAD SEKCIJI [alligator.io](https://alligator.io/react/typescript-with-react/)

A OVDE SAM NASO I NEKA OBJASNJENJA

<https://ahrefs.com/blog/open-graph-meta-tags/>

# ........ TOTALNO MOZES DA KORISTIS FaunaDB, ZAJEDNO SA NETLIFY SERVERLESS FUNKCIJAMA, U TVOM PROJEKTU

NA PRIMER, LIKES, HEARTS, I SLICNE OSTALE STVARI MOZES DEFINISATI KROZ FAUNA-U
