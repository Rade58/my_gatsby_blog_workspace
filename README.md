...
**ALI NEMA VEZE, BAR SAM SE PODSETIO KAKO CLOUDINARY FUNKCIONISE, I KAKO GA PODESITI**

***

**TAKO DA SVE SLEDECE STO SAM NAPISAO USTVARI DEFINISE KAKO SE IMPLEMENTIRA CLOUDINARY U PROJEKAT**

[CLOUDINARY](https://cloudinary.com/)

***

STO SE TICE NA NIVOU SAJTA KREIRAM OVAKVU FOLDER STRUKTURU

- GROUP PAGES MDXes IDU U FOLDER **`grouppages`**

- BLOG POST MDXes IDU U FOLDER **`blogposts`**

- BILO KAKVE SLIKE KOJE IMAJU VEZE SA CLOUDINARY-JEM IDU U FOLDER: **`cloud-images`**
...
`devicons-in-use` (**KASNIJE SAM OVO PROMENIO**)

USTVARI NEKA SE FOLDER ZOVE 

`cloud-images`

I TO SAM I REDEFINISAO U CONFIG FAJLU (REDEFINISAO PATH ZA GATSBY FILESYSTEM)
