...
SADA CU KREIRATI TAKAV FAJL, I MISLIM DA TO MZOE BITI I TYPESCRIPT; DA SECAS SE DA SE I ON MOZE RUNN-OVATI AGAINST NODE
...
const dayOfPublisha = datumPublisha.getDate()    //  DACE TI DAN U MESECU
...
// KOJE MOGU UKOMPUNOVATI DA STOJE ZAJEDNO

```

DOBRO SAM SAM TI OKVIRNO PREDSTAVIO STA MOZES SA DATE STRINGOM

BICU DETALJNIJI U SLEDECEM BRANCH-U GDE CU PREDSTAVITI MOJ PLAN U POGLEDU TOGA STA CU URADITI SA DATE-OVIMA

JER MI SE IPAK JAVILA IDEJA DA NAPISEM RESOLVER

DAKLE KREIRAM NOVI BRANCH GDE CU SE POZABAVITI DDTE-OVIMA
