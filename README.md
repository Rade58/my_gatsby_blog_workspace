...
(SECAS SE **`lang`** I **`description`** NA GROUP PAGE-U **E PA POTPUNO SI ZABORAVIO DA IH STAVIS U QUERY**)

***

**`POPRAVICU TO`** DODACU I POMENUTE FIELD-OVE U QUERY, KADA BUDEM DODAVAO I `icon` FIELD

I ZAISTA KADA SI TO POPRAVIO MOGAO SI VIDETI ODGOVARAJUCI lang ATRIBUT NA `html` TAGU-U, ALI I ONGOVARAJUCI meta DESCRIPTION TAG U U `head`-U

# OSTAJE MI DA U `packages/gatsby-theme-raedal/src/components/group-page-components/heading-major.tsx` ISKORISTIM BASE64 TAKO STO CU GA LOAD-OVATI SA GATSBY IMAGE-OM

TAK ODA CU GA INSTALIRATI

- `yarn workspace gatsby-theme-raedal add gatsby-image`

I NA KRAJU SE DESILO DA `gatsby-image` NE MOGU NIKAKO DA UVEZEM I ZATO SAM KORISTIO OBICNI IMAGE

**A KAKO SAM KORISTIO POMENUTI BASE64 STRING, MOZES VIDETI U POMENUTOJ KOMPONENTI**

DAKLE ZA OVO MI NE TREBA 'gatsby-image'

ALI TREBACE ZA CLOUDINARY

**I MORACES KADA TAD DA SAZNAS KAKO DA RESIS TAJ GATSBY IMAGE UVOZ KOJI NE FUNKCIONISE**

# ** USPEO SAM DA POSTIGNEM DA SE RESOLVE-UJE GATSY IMAGE, TAK OSTO SAM GA REINSTALIRAO I OPET INSTALIRAO **

- `yarn workspace gatsby-theme-raedal remove gatsby-image`

- `yarn workspace gatsby-theme-raedal add gatsby-image`

**MEDJUTIM NECE MI TREBATI, JER SAM USPESNO ISKORISTIO BASE64 SVG-JA, I SVE LOAD-OVAO U `img` TAG**

## JA CU USTVARI GATSBY IMAGE KORISTITI SAMO SA ASSET-IMA SA CLOUDINARY-JA

# DAKLE KAO STO SAM REKAO USPESNO SAM LOAD-OVAO SVG IMAGE, I VISE NEMA NEPOTREBNOG RERENDERINGA, KOJEG JE BILO KADA SAM SLIKU LOAD-OVAO KORISTECI REF INSIDE useEffect-A
