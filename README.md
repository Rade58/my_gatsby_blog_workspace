...
**ALI POSTO SAM SAZNAO DA OVO BAS I NIJE DOBRA PRAKSA**

`ODNOSNO NIJE DOBRO INKORPORIRATI useContext U` **CUSTOM HOOK NACINU**

# GROUP PAGE TREBA DA IMA HEADER BEZ PRASETA (ALI DO TOGA CU DOCI TEK KASNIJE)

# DAKLE GROUP PAGE CE BITI ONO STA CE HOLD-OVATI LAYOUT

DAKLE LAYOUT CU NESTOVATI UNUTAR

`packages/gatsby-theme-raedal/src/components/group-page-components/group-page.tsx`

## OSTYALI INFO JE SUVISAN, I ZATO POGLEDAJ FAJLOVE I VIDECES STA SAM DODAVAO
