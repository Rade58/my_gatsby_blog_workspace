...
# NIJE FUNKCIONISAO RESOLVER ZA `groupPage` FIELD TAKO DA SAM GA REDEFINISAO I U NJEMU QUERY-JEOVAO SPECIFIC GROUP PAGE NA OSNOVU IMENA GRUPE UZETIM SA BLOG POST-A, ODNONO SOURCE-A

I MISLIM DA JE TO SVE STA SAM TREBAO URADITI

KAO STO VIDIM BUILD SADA USPEVA

I NE MORAM DA CLEAN-UJEM CACHE PRE BUILD-A

# NISTA DRUGO NISAM MORA DA DEFINISEM, NI STO SE TICE OSTALIH RESOLVERA, A CODE KREIRANJA PAGEOVA (`createPages` HOOK) JE I DALJE VALIDAN

DAKLE TU SAM RADIO DA KAZEM VALIDENE GRAPHQL STVARI, PRAVIO QUERY-JE I NA OSNOVU QUERY-JA PRAVIO PAGE-OVE (NIGDE SE NE KORISTI (AS I NIJE SE I RANIJE KORISTIO U POMENUTOM HOOK-U JER SAM GA UKLONIO U NEKOM OD PREDHODNIH BRANCH-EVA) ONAJ NIZ IZ GLOBALNOG OBIMA, TAKO DA GA MOGU UKLONITI U POTPUNOSTI (MISLIM NA NIZ))