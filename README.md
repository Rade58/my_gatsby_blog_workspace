...
POGLEDAJ RESOLVERA (DODAO SAM TYPE I RESOLVERA, NA DNO ARGUMENT OBJEKTA createResolvers)

# NAPRAVICU SADA `author` RESOLVER-A ZA `BlogPostPageType` 

DAKLE TREBA DA SE GETT-UJE APPROPRIATE AuthorPage NODU U ODNOSU NA ID KOJI SAM PROSLEDIO IZ BLOG POST MDX FRONTMATTER-A, A TO TREBA DA ODGOVARA `authorID` FIELD-U

!!!!

**NESTO MI NE IDE U KREIRANJU OVOG RESOLVERA**

**RESIO SAM STVAR, A TREBAO MI JE SAMO BOLJI ERROR HANDLING,, ODNONO TACNIJE HANDLING ONOGA STO MOZE IZACI KAO REZULTAT runquery-JA**

`TO MOZE BITI NIZ, MOZE BITI I null AKO NISTA NIJE PRONADJENO` (OBRATI PAZNJU NA OVO)

!!!!

POGLEDAJ RESOLVER AKO TE ZANIMA STA SAM URADIO


# !!!! KAO VELIKI PODSETNIK OSTAJE TI DA NAPRAVIS MNOGO BOLJI ERROR HANDLING, ODNONO BOLJI HANDLING KADA DOBIJES null FROM runQuery INSIDE THE RESOLVER

***
***

## SADA ZELIM DA DEFINISEM KREIRANJE AUTHOR PAGE STRANICE, ALI TO CU RADITI U NOVOM BRANCH-U
