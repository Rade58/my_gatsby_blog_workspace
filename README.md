...
# SADA PROSIRUJEM TEMPLATE QUERY

MOGU DA GA PRVO DEVELOP=UJEM U GRAPHI-JU

# ZATIM PROSIRUJEM SVE TYPESCRIPT INTERFACE-OVE I PROSIRUJEM I CONTEXT-OVE DEFAULT-OVE

## POSTO SAM SVE URADIO STO SAM HTEO, MISLIM DA CU SE U SLEDECEM BRANCH-U POSVETITI PRAVLJENJEM KOMPONENTI ZA AUTHOR PAGE

TO JEST NASTAVLJAM SA PRAVLJENJEM KOMPONENTI
